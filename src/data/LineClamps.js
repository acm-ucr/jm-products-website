...
export const lineClampsData = [
  ...
  {
    text: "Line clamps are available with or without cushion materials; clamps with cushion materials are typically utilized for vibration intense conditions. J&M Products utilize a wide variety of specialized elastomer cushion materials for use in extreme environments, such as exposure to fuel and hydraulic fluids with temperature fluctuations from 500°F. to -20°F.",
    img: LineClamp2,
    float: "right",
  },
  {
    text: "Reliable, proven, off-the-shelf standard MS, NAS, AN and J&M Part numbers, J&M clamps provide fast economical methods of installing wire harnesses, hydraulic lines, or a variety of other applications. J&M line clamps are utilized by virtually every aircraft manufacturer and defense contractor. Heavy duty trucking, Space and Marine applications are also part of our product line.",
    img: LineClamp3,
    float: "",
  },
  {
    text: "J&M can customize any required mounting brackets where vibration or loads would exceed clamp, component design limits, or if compound angles are required. Brackets can include the installation of secondary fastening devices as required.",
    img: LineClamp4,
    float: "right",
  },
];
