...
const NotFound = () => {
  return (
    <div className="flex relative w-full min-h-24 sm:min-h-28 md:min-h-screen justify-center items-center overflow-hidden">
      ...
      <div className="absolute flex flex-col items-center justify-center font-hk text-white tracking-widest text-center z-10">
        <p className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-semibold mb-4">
          404
        </p>
        <p className="w-1/2 sm:w-1/3 text-xs sm:text-lg lg:text-2xl xl:text-3xl font-light mb-6">
