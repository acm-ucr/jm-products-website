...
const HarnessAssembly = () => {
  return (
    <div>
      <h1 className="font-Noto Sans HK flex justify-center text-transparent bg-clip-text bg-gradient-to-r from-jm-blue-300 via-jm-blue-200 to-jm-blue-100 text-[32px] mb-6 tracking-wide underline-offset-8 whitespace-break-spaces underline decoration-jm-blue-200 ">
        <b>J&M Products Harness Assembly Overview </b>
      </h1>
      <div className="flex justify-center">
        <ul className=" text-left text-[14px] list-disc flex flex-col font-Noto Sans HK w-5/12 tracking-wider">
          <li>
            {" "}
